...
!$acc declare copyin (epsilo, tmelt, tboil, omeps, h2otrip)


PUBLIC wv_sat_qsat_water_vect 
PUBLIC wv_sat_qsat_ice_vect 

! pressure -> humidity conversion

PUBLIC wv_sat_svp_to_qsat_vect 
! Combined qsat operations


PUBLIC wv_sat_svp_water_vect 
PUBLIC wv_sat_svp_ice_vect 
