...
!--------------------------------------------------------------------
      ...
      real(rkind_comp), dimension(veclen,clscnt4), intent(out) :: &
            prod, &
            loss
...
!--------------------------------------------------------------------
      ...
      do k = 1,avec_len
       ...
       do k = 1,avec_len
         ...
         prod(k,146) = (rxt(k,1) +2.000_rkind_comp*rxt(k,2) +rxt(k,95) +rxt(k,96) +rxt(k,97) + &
                 2.000_rkind_comp*rxt(k,100) +rxt(k,107) +rxt(k,108) +rxt(k,109) + &
                 2.000_rkind_comp*rxt(k,112) +rxt(k,129)*y(k,3) +rxt(k,130)*y(k,3) + &
                 rxt(k,182)*y(k,8) +rxt(k,449)*y(k,130) +rxt(k,457)*y(k,129))*y(k,4) &
                  + (rxt(k,183)*y(k,9) +rxt(k,184)*y(k,10) +rxt(k,454)*y(k,128)) &
                 *y(k,8) + (rxt(k,461)*y(k,131) +1.150_rkind_comp*rxt(k,462)*y(k,128)) &
       ...
       do k = 1,avec_len
         prod(k,129) = (rxt(k,163)*y(k,22) +rxt(k,167)*y(k,23) +rxt(k,173)*y(k,2) + &
                 ...
                 .750_rkind_comp*rxt(k,349)*y(k,76))*y(k,24) + (rxt(k,4) + &
                 2.000_rkind_comp*rxt(k,116)*y(k,2) +2.000_rkind_comp*rxt(k,134)*y(k,3) + &
                 ...
                 2.000_rkind_comp*rxt(k,125)*y(k,4))*y(k,6) +rxt(k,133)*y(k,7)*y(k,3) &
       ...
       do k = 1,avec_len
         ...
         prod(k,115) = (rxt(k,17) +rxt(k,18) +rxt(k,209)*y(k,28) +rxt(k,233)*y(k,37) + &
                 rxt(k,266)*y(k,11) +rxt(k,267)*y(k,23) +rxt(k,268)*y(k,2))*y(k,19) &
                  + (.500_rkind_comp*rxt(k,290)*y(k,44) +.560_rkind_comp*rxt(k,311)*y(k,59) + &
                 .050_rkind_comp*rxt(k,333)*y(k,77) +.200_rkind_comp*rxt(k,339)*y(k,78) + &
                 .300_rkind_comp*rxt(k,357)*y(k,83))*y(k,1) + (.220_rkind_comp*rxt(k,340)*y(k,9) + &
                 .220_rkind_comp*rxt(k,342)*y(k,11) +.110_rkind_comp*rxt(k,344)*y(k,16) + &
                 .220_rkind_comp*rxt(k,345)*y(k,48))*y(k,79) + (.250_rkind_comp*rxt(k,375)*y(k,9) + &
                 .500_rkind_comp*rxt(k,376)*y(k,11) +.200_rkind_comp*rxt(k,378)*y(k,16) + &
                 .250_rkind_comp*rxt(k,379)*y(k,48))*y(k,91) + (.350_rkind_comp*rxt(k,283)*y(k,135) + &
                 rxt(k,306)*y(k,53) +rxt(k,327)*y(k,68))*y(k,23) + (rxt(k,74) + &
                 rxt(k,328)*y(k,11))*y(k,68) +rxt(k,251)*y(k,108)*y(k,28) +rxt(k,61) &
                 *y(k,50) +rxt(k,79)*y(k,52) +2.000_rkind_comp*rxt(k,82)*y(k,53) &
       ...
       do k = 1,avec_len
         loss(k,134) = (rxt(k,189)* y(k,1) +rxt(k,187)* y(k,2) +rxt(k,183)* y(k,8) &
                 ...
                 * y(k,128) +rxt(k,278)* y(k,137) + rxt(k,6) + rxt(k,7) &
                  + het_rates(k,9))* y(k,9)
         prod(k,134) = (rxt(k,8) +.500_rkind_comp*rxt(k,402) +2.000_rkind_comp*rxt(k,185)*y(k,8) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,144) = (rxt(k,187)*y(k,2) +rxt(k,188)*y(k,24) +rxt(k,189)*y(k,1) + &
                 2.000_rkind_comp*rxt(k,197)*y(k,11) +rxt(k,216)*y(k,30) +rxt(k,237)*y(k,38) + &
                 ...
                 .920_rkind_comp*rxt(k,359)*y(k,88) +1.206_rkind_comp*rxt(k,365)*y(k,89) + &
                 .900_rkind_comp*rxt(k,372)*y(k,84) +rxt(k,375)*y(k,91) + &
                 .900_rkind_comp*rxt(k,383)*y(k,96) +.900_rkind_comp*rxt(k,390)*y(k,100) + &
                 .900_rkind_comp*rxt(k,393)*y(k,103) +rxt(k,397)*y(k,106))*y(k,9) &
                  + (rxt(k,12) +rxt(k,198)*y(k,2) +rxt(k,199)*y(k,23) + &
                 rxt(k,200)*y(k,24) +rxt(k,342)*y(k,79) +rxt(k,348)*y(k,76) + &
                 rxt(k,360)*y(k,88) +1.206_rkind_comp*rxt(k,366)*y(k,89) +rxt(k,370)*y(k,90) + &
                 rxt(k,376)*y(k,91) +rxt(k,396)*y(k,105))*y(k,11) + (rxt(k,15) + &
                 rxt(k,203) +rxt(k,202)*y(k,23))*y(k,13) + (rxt(k,9) +rxt(k,194)) &
                 *y(k,14) + (rxt(k,329)*y(k,82) +.400_rkind_comp*rxt(k,369)*y(k,90))*y(k,23) &
                  + (.600_rkind_comp*rxt(k,64) +rxt(k,308))*y(k,58) + (rxt(k,65) +rxt(k,354)) &
       ...
       do k = 1,avec_len
         loss(k,138) = (rxt(k,166)* y(k,1) +rxt(k,165)* y(k,2) +rxt(k,181)* y(k,8) &
                 ...
                 * y(k,20) +rxt(k,170)* y(k,21) + 2._rkind_comp*(rxt(k,168) +rxt(k,169)) &
       ...
       do k = 1,avec_len
         prod(k,138) = (rxt(k,161)*y(k,22) +rxt(k,174)*y(k,24) + &
                 ...
                 .270_rkind_comp*rxt(k,357)*y(k,83) +.700_rkind_comp*rxt(k,395)*y(k,105))*y(k,1) &
                 ...
                 rxt(k,245)*y(k,40) +rxt(k,268)*y(k,19))*y(k,2) &
                  + (rxt(k,153)*y(k,15) +2.000_rkind_comp*rxt(k,131)*y(k,134) + &
                 rxt(k,156)*y(k,21) +rxt(k,157)*y(k,33) +rxt(k,158)*y(k,39) + &
                 rxt(k,159)*y(k,42))*y(k,3) + (.300_rkind_comp*rxt(k,275)*y(k,17) + &
                 .650_rkind_comp*rxt(k,283)*y(k,135) +.500_rkind_comp*rxt(k,296)*y(k,47) + &
                 .500_rkind_comp*rxt(k,320)*y(k,65) +.100_rkind_comp*rxt(k,346)*y(k,80))*y(k,23) &
                  + (2.000_rkind_comp*rxt(k,162)*y(k,22) +rxt(k,188)*y(k,9) + &
                 rxt(k,200)*y(k,11) +rxt(k,208)*y(k,28) +.206_rkind_comp*rxt(k,367)*y(k,89)) &
                 *y(k,24) + (rxt(k,19) +rxt(k,247)*y(k,141))*y(k,134) &
                  +.500_rkind_comp*rxt(k,402)*y(k,10) +rxt(k,11)*y(k,12) +rxt(k,14)*y(k,13) &
                  +rxt(k,16)*y(k,17) +2.000_rkind_comp*rxt(k,22)*y(k,25) +rxt(k,27)*y(k,34) &
       ...
       do k = 1,avec_len
         ...
         prod(k,135) = (rxt(k,196)*y(k,12) +rxt(k,229)*y(k,35) +rxt(k,309)*y(k,58) + &
                 .500_rkind_comp*rxt(k,355)*y(k,81))*y(k,23) + (rxt(k,191)*y(k,10) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,131) = (rxt(k,433) +rxt(k,439) +rxt(k,444) +rxt(k,435)*y(k,33) + &
                 ...
                 rxt(k,407)*y(k,157))*y(k,11) + (2.000_rkind_comp*rxt(k,400) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,136) = (rxt(k,299)*y(k,9) +.900_rkind_comp*rxt(k,302)*y(k,16) + &
                 2.000_rkind_comp*rxt(k,303)*y(k,48) +rxt(k,345)*y(k,79) +rxt(k,351)*y(k,76) + &
                 rxt(k,364)*y(k,88) +rxt(k,379)*y(k,91))*y(k,48) &
                  + (rxt(k,153)*y(k,3) +rxt(k,210)*y(k,28) +rxt(k,249)*y(k,141) + &
                 rxt(k,263)*y(k,23))*y(k,15) + (.700_rkind_comp*rxt(k,275)*y(k,17) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,140) = (rxt(k,215)*y(k,30) +rxt(k,270)*y(k,9) + &
                 2.000_rkind_comp*rxt(k,272)*y(k,16) +rxt(k,273)*y(k,16) + &
                 .700_rkind_comp*rxt(k,294)*y(k,46) +rxt(k,302)*y(k,48) +rxt(k,315)*y(k,61) + &
                 .800_rkind_comp*rxt(k,324)*y(k,67) +.880_rkind_comp*rxt(k,344)*y(k,79) + &
                 2.000_rkind_comp*rxt(k,350)*y(k,76) +1.200_rkind_comp*rxt(k,363)*y(k,88) + &
                 .800_rkind_comp*rxt(k,378)*y(k,91))*y(k,16) + (.500_rkind_comp*rxt(k,286)*y(k,55) + &
                 rxt(k,318)*y(k,64) +rxt(k,322)*y(k,67) +.500_rkind_comp*rxt(k,331)*y(k,73) + &
                 .250_rkind_comp*rxt(k,340)*y(k,79) +rxt(k,347)*y(k,76) + &
                 .550_rkind_comp*rxt(k,359)*y(k,88) +.072_rkind_comp*rxt(k,365)*y(k,89) + &
                 .100_rkind_comp*rxt(k,372)*y(k,84) +.250_rkind_comp*rxt(k,375)*y(k,91))*y(k,9) &
                  + (rxt(k,274)*y(k,18) +.300_rkind_comp*rxt(k,275)*y(k,17) + &
                 .500_rkind_comp*rxt(k,304)*y(k,54) +.800_rkind_comp*rxt(k,305)*y(k,52) + &
                 rxt(k,309)*y(k,58) +.500_rkind_comp*rxt(k,355)*y(k,81))*y(k,23) &
                  + (rxt(k,290)*y(k,44) +.540_rkind_comp*rxt(k,311)*y(k,59) + &
                 .800_rkind_comp*rxt(k,333)*y(k,77) +.700_rkind_comp*rxt(k,339)*y(k,78) + &
                 .600_rkind_comp*rxt(k,357)*y(k,83))*y(k,1) + (.250_rkind_comp*rxt(k,342)*y(k,79) + &
                 rxt(k,348)*y(k,76) +.600_rkind_comp*rxt(k,360)*y(k,88) + &
                 .072_rkind_comp*rxt(k,366)*y(k,89))*y(k,11) + (.250_rkind_comp*rxt(k,345)*y(k,79) + &
                 rxt(k,351)*y(k,76) +.600_rkind_comp*rxt(k,364)*y(k,88) + &
                 .250_rkind_comp*rxt(k,379)*y(k,91))*y(k,48) + (rxt(k,154)*y(k,15) + &
                 rxt(k,155)*y(k,15))*y(k,3) +rxt(k,16)*y(k,17) &
                  +.206_rkind_comp*rxt(k,367)*y(k,89)*y(k,24) +rxt(k,79)*y(k,52) &
                  +2.000_rkind_comp*rxt(k,289)*y(k,56) +rxt(k,62)*y(k,65) +rxt(k,78)*y(k,66) &
       ...
       do k = 1,avec_len
         ...
         prod(k,141) = (rxt(k,156)*y(k,3) +rxt(k,170)*y(k,23) +rxt(k,172)*y(k,2) + &
                 ...
                 rxt(k,267)*y(k,19))*y(k,23) + (rxt(k,19) +2.000_rkind_comp*rxt(k,21)) &
       ...
       do k = 1,avec_len
         loss(k,142) = (rxt(k,174)* y(k,1) +rxt(k,173)* y(k,2) +rxt(k,188)* y(k,9) &
                  ...
                  +rxt(k,167)* y(k,23) + 2._rkind_comp*rxt(k,175)* y(k,24) + (rxt(k,207) + &
       ...
       do k = 1,avec_len
         prod(k,142) = (rxt(k,252)*y(k,108) +rxt(k,255)*y(k,109) +rxt(k,166)*y(k,1) + &
                 ...
                 .350_rkind_comp*rxt(k,283)*y(k,135) +rxt(k,305)*y(k,52) +rxt(k,306)*y(k,53) + &
                 rxt(k,307)*y(k,51) +rxt(k,326)*y(k,66) +.200_rkind_comp*rxt(k,346)*y(k,80) + &
                 .500_rkind_comp*rxt(k,355)*y(k,81) +rxt(k,369)*y(k,90) + &
                 .250_rkind_comp*rxt(k,382)*y(k,94) +.500_rkind_comp*rxt(k,406)*y(k,157))*y(k,23) &
                  + (rxt(k,270)*y(k,16) +rxt(k,278)*y(k,137) + &
                 .250_rkind_comp*rxt(k,286)*y(k,55) +rxt(k,292)*y(k,46) +rxt(k,313)*y(k,61) + &
                 rxt(k,318)*y(k,64) +rxt(k,331)*y(k,73) +.470_rkind_comp*rxt(k,340)*y(k,79) + &
                 .920_rkind_comp*rxt(k,359)*y(k,88) +.794_rkind_comp*rxt(k,365)*y(k,89) + &
                 .900_rkind_comp*rxt(k,372)*y(k,84) +rxt(k,375)*y(k,91) + &
                 .900_rkind_comp*rxt(k,383)*y(k,96) +.900_rkind_comp*rxt(k,390)*y(k,100) + &
                 .900_rkind_comp*rxt(k,393)*y(k,103) +rxt(k,397)*y(k,106))*y(k,9) &
                  + (rxt(k,215)*y(k,30) +2.000_rkind_comp*rxt(k,272)*y(k,16) + &
                 rxt(k,294)*y(k,46) +.900_rkind_comp*rxt(k,302)*y(k,48) +rxt(k,315)*y(k,61) + &
                 .300_rkind_comp*rxt(k,324)*y(k,67) +.730_rkind_comp*rxt(k,344)*y(k,79) + &
                 rxt(k,350)*y(k,76) +rxt(k,363)*y(k,88) +.800_rkind_comp*rxt(k,378)*y(k,91)) &
                 *y(k,16) + (.120_rkind_comp*rxt(k,290)*y(k,44) +.190_rkind_comp*rxt(k,311)*y(k,59) + &
                 .060_rkind_comp*rxt(k,333)*y(k,77) +.275_rkind_comp*rxt(k,339)*y(k,78) + &
                 .060_rkind_comp*rxt(k,357)*y(k,83) +rxt(k,395)*y(k,105))*y(k,1) &
                  + (rxt(k,266)*y(k,19) +.470_rkind_comp*rxt(k,342)*y(k,79) + &
                 rxt(k,360)*y(k,88) +.794_rkind_comp*rxt(k,366)*y(k,89) +rxt(k,370)*y(k,90) + &
                 rxt(k,376)*y(k,91))*y(k,11) + (rxt(k,251)*y(k,108) + &
                 rxt(k,256)*y(k,109) +rxt(k,206)*y(k,25) +rxt(k,209)*y(k,19))*y(k,28) &
                  + (.470_rkind_comp*rxt(k,345)*y(k,79) +rxt(k,364)*y(k,88) + &
                 rxt(k,379)*y(k,91))*y(k,48) + (rxt(k,176)*y(k,25) + &
                 rxt(k,268)*y(k,19))*y(k,2) + (rxt(k,160)*y(k,22) +rxt(k,288)*y(k,56)) &
                 *y(k,4) + (rxt(k,15) +rxt(k,203))*y(k,13) + (1.340_rkind_comp*rxt(k,66) + &
                 .660_rkind_comp*rxt(k,67))*y(k,78) +rxt(k,154)*y(k,15)*y(k,3) &
                  +.700_rkind_comp*rxt(k,387)*y(k,98)*y(k,10) +rxt(k,233)*y(k,37)*y(k,19) &
                  +1.200_rkind_comp*rxt(k,295)*y(k,46)*y(k,46) +rxt(k,69)*y(k,47) +rxt(k,61) &
                 *y(k,50) +2.000_rkind_comp*rxt(k,79)*y(k,52) +2.000_rkind_comp*rxt(k,82)*y(k,53) &
       ...
       do k = 1,avec_len
         prod(k,130) = (rxt(k,252)*y(k,108) +rxt(k,253)*y(k,115) + &
                 ...
                 rxt(k,325)*y(k,69) +rxt(k,327)*y(k,68) +.500_rkind_comp*rxt(k,338)*y(k,78) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,145) = (2.000_rkind_comp*rxt(k,135)*y(k,110) +2.000_rkind_comp*rxt(k,136)*y(k,111) + &
                 2.000_rkind_comp*rxt(k,137)*y(k,112) +2.000_rkind_comp*rxt(k,138)*y(k,120) + &
                 rxt(k,139)*y(k,121) +rxt(k,140)*y(k,113) +rxt(k,141)*y(k,118) + &
                 rxt(k,142)*y(k,119) +4.000_rkind_comp*rxt(k,143)*y(k,114) + &
                 rxt(k,145)*y(k,117) +rxt(k,152)*y(k,139) +rxt(k,157)*y(k,33))*y(k,3) &
                  + (rxt(k,24) +rxt(k,211)*y(k,2) +rxt(k,212)*y(k,23) + &
                 rxt(k,215)*y(k,16) +rxt(k,216)*y(k,9) +2.000_rkind_comp*rxt(k,218)*y(k,30) + &
                 rxt(k,220)*y(k,30) +rxt(k,240)*y(k,38))*y(k,30) &
                  + (rxt(k,252)*y(k,108) +3.000_rkind_comp*rxt(k,253)*y(k,115) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,137) = (rxt(k,210)*y(k,15) +2.000_rkind_comp*rxt(k,251)*y(k,108) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,133) = (rxt(k,144)*y(k,109) +rxt(k,145)*y(k,117) + &
                 rxt(k,146)*y(k,116) +2.000_rkind_comp*rxt(k,147)*y(k,122) + &
                 2.000_rkind_comp*rxt(k,148)*y(k,123) +3.000_rkind_comp*rxt(k,149)*y(k,124) + &
                 2.000_rkind_comp*rxt(k,150)*y(k,125) +rxt(k,158)*y(k,39))*y(k,3) &
                  + (rxt(k,32) +rxt(k,234)*y(k,2) +rxt(k,235)*y(k,23) + &
                 rxt(k,237)*y(k,9) +rxt(k,239)*y(k,30) +rxt(k,240)*y(k,30) + &
                 2.000_rkind_comp*rxt(k,242)*y(k,38))*y(k,38) + (rxt(k,255)*y(k,109) + &
                 2.000_rkind_comp*rxt(k,259)*y(k,125) +3.000_rkind_comp*rxt(k,260)*y(k,124) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,76) = (rxt(k,451)*y(k,2) +.900_rkind_comp*rxt(k,463)*y(k,132))*y(k,127) &
                  +.800_rkind_comp*rxt(k,461)*y(k,132)*y(k,131)
       ...
       do k = 1,avec_len
         ...
         prod(k,116) = (rxt(k,292)*y(k,46) +.270_rkind_comp*rxt(k,313)*y(k,61) + &
                 ...
                 .400_rkind_comp*rxt(k,372)*y(k,84))*y(k,9) + (.500_rkind_comp*rxt(k,311)*y(k,59) + &
                 .040_rkind_comp*rxt(k,333)*y(k,77))*y(k,1) + (.500_rkind_comp*rxt(k,296)*y(k,47) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,127) = (rxt(k,322)*y(k,67) +rxt(k,335)*y(k,74) + &
                 .530_rkind_comp*rxt(k,340)*y(k,79) +rxt(k,347)*y(k,76))*y(k,9) &
                  + (rxt(k,298)*y(k,50) +rxt(k,328)*y(k,68) + &
                 .530_rkind_comp*rxt(k,342)*y(k,79) +rxt(k,348)*y(k,76))*y(k,11) &
                  + (.300_rkind_comp*rxt(k,324)*y(k,67) +.260_rkind_comp*rxt(k,344)*y(k,79) + &
                 rxt(k,350)*y(k,76))*y(k,16) + (rxt(k,297)*y(k,50) + &
                 .500_rkind_comp*rxt(k,304)*y(k,54) +rxt(k,327)*y(k,68))*y(k,23) &
                  + (.600_rkind_comp*rxt(k,64) +rxt(k,308))*y(k,58) &
                  +.530_rkind_comp*rxt(k,345)*y(k,79)*y(k,48) +rxt(k,73)*y(k,63) +rxt(k,78) &
       ...
       do k = 1,avec_len
         ...
         prod(k,61) =.100_rkind_comp*rxt(k,372)*y(k,84)*y(k,9) +rxt(k,312)*y(k,59)*y(k,11)
       ...
       do k = 1,avec_len
         ...
         prod(k,95) = (.020_rkind_comp*rxt(k,359)*y(k,88) +.250_rkind_comp*rxt(k,375)*y(k,91) + &
                 ...
                 .340_rkind_comp*rxt(k,393)*y(k,103))*y(k,9) + (.250_rkind_comp*rxt(k,376)*y(k,11) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,119) = (.230_rkind_comp*rxt(k,359)*y(k,9) +.250_rkind_comp*rxt(k,360)*y(k,11) + &
                 .190_rkind_comp*rxt(k,363)*y(k,16) +.250_rkind_comp*rxt(k,364)*y(k,48))*y(k,88) &
                  + (.167_rkind_comp*rxt(k,365)*y(k,9) +.167_rkind_comp*rxt(k,366)*y(k,11) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,124) = (rxt(k,332)*y(k,77) +.500_rkind_comp*rxt(k,338)*y(k,78) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,126) = (.500_rkind_comp*rxt(k,338)*y(k,78) +.500_rkind_comp*rxt(k,346)*y(k,80)) &
                 *y(k,23) + (rxt(k,65) +rxt(k,354))*y(k,81) &
                  +.200_rkind_comp*rxt(k,357)*y(k,83)*y(k,1) +.660_rkind_comp*rxt(k,66)*y(k,78)
       ...
       do k = 1,avec_len
         ...
         prod(k,94) = (.820_rkind_comp*rxt(k,313)*y(k,61) +.500_rkind_comp*rxt(k,331)*y(k,73) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,79) = (rxt(k,273)*y(k,16) +.300_rkind_comp*rxt(k,294)*y(k,46) + &
                 .500_rkind_comp*rxt(k,324)*y(k,67) +.250_rkind_comp*rxt(k,344)*y(k,79) + &
       ...
       do k = 1,avec_len
         ...
         prod(k,121) = (.250_rkind_comp*rxt(k,340)*y(k,79) +.020_rkind_comp*rxt(k,359)*y(k,88) + &
                 .250_rkind_comp*rxt(k,375)*y(k,91) +.450_rkind_comp*rxt(k,383)*y(k,96) + &
                 .540_rkind_comp*rxt(k,393)*y(k,103))*y(k,9) + (.500_rkind_comp*rxt(k,324)*y(k,67) + &
                 .240_rkind_comp*rxt(k,344)*y(k,79) +.100_rkind_comp*rxt(k,378)*y(k,91))*y(k,16) &
                  + (.950_rkind_comp*rxt(k,333)*y(k,77) +.800_rkind_comp*rxt(k,339)*y(k,78))*y(k,1) &
                  + (.250_rkind_comp*rxt(k,342)*y(k,79) +.250_rkind_comp*rxt(k,376)*y(k,91))*y(k,11) &
       ...
       do k = 1,avec_len
         loss(k,122) = (rxt(k,375)* y(k,9) +rxt(k,376)* y(k,11) +rxt(k,378)* y(k,16) &
                 ...
                 * y(k,91)
         prod(k,122) = (.800_rkind_comp*rxt(k,362)*y(k,93) +rxt(k,371)*y(k,87) + &
